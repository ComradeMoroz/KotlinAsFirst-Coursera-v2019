...
//        assertEquals("двенадцать", russian(12))
        assertEquals("сто одинадцать", russian(111))
        assertEquals("девятьсот девятнадцать", russian(919))
        assertEquals("пятьсот тринадцать", russian(513))
        assertEquals("девятьсот девяносто девять", russian(999))
        assertEquals("сто ноль один", russian(101))
